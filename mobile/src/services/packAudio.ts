...
/** Download one clip if not already present. Returns the local uri, or null. */
...
/** Download every referenced clip in a pack for offline use. */
...
/** True when all clips referenced by the pack are present locally. */
